...
from workoutapi.app.categorias.schemas import CategoriaIn
from workoutapi.app.centro_treinamento.schemas import CentroTreinamentoAtleta
...
class AtletaUpdate(BaseSchema):
    nome: Annotated[Optional[str], Field(None, description='Nome do atleta', example='João Ferreira Silva', max_length=50)]
